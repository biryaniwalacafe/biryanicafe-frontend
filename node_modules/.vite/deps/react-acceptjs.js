...
// node_modules/react-acceptjs/dist/index.modern.js
...
function useScript(url, async, appendToHeadOrBody) {
  ...
  React.useEffect(function() {
    if (cachedScripts.includes(url)) {
      ...
      appendToHeadOrBody === "head" ? document.head.appendChild(script_1) : document.body.appendChild(script_1);
      return function() {
...
var useAcceptJs = function(_a) {
  ...
  var _c = (0, import_react.useState)(true), loading = _c[0], setLoading = _c[1];
  ...
  var dispatchData = function(paymentData) {
    var payload = paymentData.cardData ? { cardData: paymentData.cardData, authData } : { bankData: paymentData.bankData, authData };
...
var HostedForm = function(_a) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", __assign({ style: containerStyle, className: containerClassName ? containerClassName : void 0 }, { children: [(0, import_jsx_runtime.jsx)("button", __assign({ type: "button", style: buttonStyle, className: buttonClassName ? "AcceptUI ".concat(buttonClassName) : "AcceptUI", "data-billingaddressoptions": JSON.stringify(billingAddressOptions), "data-apiloginid": authData.apiLoginID, "data-clientkey": authData.clientKey, "data-acceptuiformbtntxt": formButtonText, "data-acceptuiformheadertxt": formHeaderText, "data-paymentoptions": JSON.stringify(paymentOptions), "data-responsehandler": "responseHandler", disabled: scriptError || loading || disabled }, { children: buttonText })), errors && (0, import_jsx_runtime.jsx)("div", __assign({ style: errorTextStyle, className: errorTextClassName !== null && errorTextClassName !== void 0 ? errorTextClassName : "" }, { children: typeof errors === "string" ? errors : errors.map(function(error, index) {
    return (0, import_jsx_runtime.jsxs)("div", { children: ["`Error ($", error.code, "): $", error.text, ")`"] }, "error-".concat(index));
  }) }))] }));
};
var RedirectIntegration = function(_a) {
  ...
  return (0, import_jsx_runtime.jsxs)("form", __assign({ method: "post", action: postUrl }, { children: [(0, import_jsx_runtime.jsx)("input", { type: "hidden", name: "token", value: formToken }), (0, import_jsx_runtime.jsx)("button", __assign({ className, style: className ? {} : style }, { children }))] }));
};
...
var IFrameIntegrationContext = import_react.default.createContext(null);
var useIFrameIntegrationContext = function() {
  var context = import_react.default.useContext(IFrameIntegrationContext);
  if (!context) {
...
var IFrameIntegration = function(_a) {
  ...
  var _b = import_react.default.useState(false), popupIsShown = _b[0], setPopupIsShown = _b[1];
  var popupFormRef = import_react.default.useRef(null);
  var popupRef = import_react.default.useRef(null);
  var iFrameRef = import_react.default.useRef(null);
  ...
  return (0, import_jsx_runtime.jsx)(IFrameIntegrationContext.Provider, __assign({ value: contextValue }, { children }));
};
var IFrameIntegrationButton = function(_a) {
  ...
  return (0, import_jsx_runtime.jsxs)("form", __assign({ method: "post", action: postUrl, id: "formAuthorizeNetPopup", name: "formAuthorizeNetPopup", target: "iframeAuthorizeNet", onSubmit: handleShowPopup }, { children: [(0, import_jsx_runtime.jsx)("input", { type: "hidden", id: "popupToken", name: "token", value: formToken }), (0, import_jsx_runtime.jsx)("button", __assign({ disabled: popupIsShown, className }, { children }))] }));
};
var IFrameContainer = function(_a) {
  ...
  var _c = import_react.default.useState(0), offsetWidth = _c[0], setOffsetWidth = _c[1];
  var _d = import_react.default.useState(0), offsetHeight = _d[0], setOffsetHeight = _d[1];
  import_react.default.useEffect(function() {
    var _a2, _b2;
    console.log("In useEffect...");
    setOffsetWidth(Math.floor((((_a2 = popupRef.current) === null || _a2 === void 0 ? void 0 : _a2.clientWidth) || 0) / 2));
    setOffsetHeight(Math.floor((((_b2 = popupRef.current) === null || _b2 === void 0 ? void 0 : _b2.clientHeight) || 0) / 2));
  }, [popupRef]);
  return (0, import_jsx_runtime.jsx)("div", __assign({ className, ref: popupRef, style: className ? { display: popupIsShown ? "" : "none" } : __assign(__assign(__assign({}, defaultContainerStyle), style), { display: popupIsShown ? "" : "none", width: windowSize.width ? windowSize.width > 576 ? "70%" : "300px" : "300px", height: "90%", marginLeft: "-".concat(offsetWidth, "px"), marginTop: "-".concat(offsetHeight, "px") }) }, { children }));
};
var IFrameBackdrop = function(_a) {
  ...
  return (0, import_jsx_runtime.jsx)("div", { className, style: className ? { display: popupIsShown ? "" : "none" } : __assign(__assign(__assign({}, defaultBackdropStyle), style), { display: popupIsShown ? "" : "none" }) });
};
var IFrame = function(_a) {
  var className = _a.className, style = _a.style;
  return (0, import_jsx_runtime.jsx)("iframe", { name: "iframeAuthorizeNet", id: "iframeAuthorizeNet", frameBorder: "0", scrolling: "no", width: "100%", height: "100%", className, style: className ? {} : style });
};
var AcceptHosted = function(props) {
  ...
  if (props.integration === "redirect") {
    return (0, import_jsx_runtime.jsx)(RedirectIntegration, __assign({ formToken: props.formToken, postUrl }, { children: props.children }));
  }
  if (props.integration === "iframe") {
    return (0, import_jsx_runtime.jsx)(IFrameIntegration, __assign({ formToken: props.formToken, postUrl, onTransactionResponse: props.onTransactionResponse, onCancel: props.onCancel, onResize: props.onResize, onSuccessfulSave: props.onSuccessfulSave }, { children: props.children }));
  }
  return null;
};
...
react-acceptjs/dist/index.modern.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=react-acceptjs.js.map
