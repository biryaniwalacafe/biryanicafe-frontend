...
//   const RESTAURANT_LOCATION = { lat: 17.6868, lon: 83.2185 };
...
//   // Add this haversine distance calculation function before the component
...
//   // Update the total calculation to include delivery fee
//   const total = subtotal + totalCharges - discountAmount + deliveryFee;

//   // Update the handleCheckout function to pass delivery info
//   const handleCheckout = () => {
//     if (isAuthenticated) {
...
//                             <p className="text-blue-600">Delivery fee: $10</p>
//                           )}
//                         </div>
//                       )}
...
export default function Cart() {
  ...
  const RESTAURANT_LOCATION = {
    lat: 17.77097894202615,
    lon: 83.21961199390776,
  };
