        ...
        <main className="flex-1 flex items-center justify-center">
          <Card className="max-w-lg w-full mx-4">
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <p className="text-muted-foreground mb-2">Order #ORD{Math.floor(Math.random() * 10000)}</p>
              ...
              <div className="space-y-3">
                ...
                <Button variant="outline" className="w-full" onClick={() => setLocation("/profile")} data-testid="button-view-orders">
                  View My Orders
                </Button>
              </div>
            </CardContent>
                  ...
                  <RadioGroup value={selectedAddress} onValueChange={setSelectedAddress}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {mockAddresses.map((address) => (
                        <Card key={address.id} className="hover-elevate cursor-pointer">
            ...
            <div>
              <Card className="sticky top-20">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full" size="lg" onClick={handlePlaceOrder} data-testid="button-place-order">
                    Place Order
                  </Button>
                </CardContent>
              </Card>
